...
public class DBTester1 {
    public static void main(String args[]) throws Exception {
        ...
        //连接到数据库的URL
        String dbUrl = "jdbc:mysql://localhost:3306/STOREDB?useUnicode=true&characterEncoding=utf-8";
        String dbUser = "root";
        String dbPwd = "root";
        //建立数据库连接
//        con = java.sql.DriverManager.getConnection(dbUrl, dbUser, dbPwd);
        ...
        //增加新记录
        stmt.executeUpdate("insert into CUSTOMERS (NAME,AGE,ADDRESS) " + "VALUES ('小王',20,'上海')");
